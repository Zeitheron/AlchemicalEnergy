...
public class BlockAlchemicalCrafter
		extends BlockDeviceHC<TileAlchemicalCrafter>
		implements IBlockHorizontal, IBlockEnableable
{
	public BlockAlchemicalCrafter()
	{
		super(Material.IRON, TileAlchemicalCrafter.class, "alchemical_crafter");
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		if(!worldIn.isRemote)
		{
			...
			if(fh != null)
			{
				TileAlchemicalCrafter alch = Cast.cast(worldIn.getTileEntity(pos), TileAlchemicalCrafter.class);
